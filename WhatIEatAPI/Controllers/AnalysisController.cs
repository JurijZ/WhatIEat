...
namespace WhatIEatAPI.Controllers
{
    ...
    public class AnalysisController : Controller
    {
        ...
        public AnalysisController(IHostingEnvironment env, IMemoryCache memoryCache, ILogger<AnalysisController> logger)
        {
            this.hostingEnv = env;
            _cache = memoryCache;
            _logger = logger;
        ...
        public async Task<IActionResult> Post()
        {
            ...
            long size = 0;
            var files = Request.Form.Files; // Reads the files selected in the web form
        ...
        private async Task<string> CallOCR(string _filename)
        {
            ...
            using (FileStream fileStream = new FileStream(_filename, FileMode.Open, FileAccess.Read, FileShare.Read, 1024, useAsync: true))
            {
                ...
                {
                    _logger.LogError(1, webEx, "Exception detected: ");

                    return TextAnalyser("Nothing");
                }
